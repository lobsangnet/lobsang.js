# `@lobsangnet/lobsang-formatter-schema`

Formats a message after validation against a schema.
...
[![NPM package @lobsangnet/lobsang-formatter-schema][npm-package-badge]][npm-package-website]
...
```js
const lobsangFormatterSchema = require('@lobsangnet/lobsang-formatter-schema')

const message = 'My message'
const topic = 'NEWS'
lobsangFormatterSchema(message, topic)
...
[codecov-report]: https://codecov.io/gh/lobsangnet/lobsang.js/tree/master/packages/lobsang-formatter-schema/lib
...
[npm-package-badge]: https://nodei.co/npm/@lobsangnet/lobsang-formatter-schema.png
[npm-package-website]: https://npmjs.org/package/@lobsangnet/lobsang-formatter-schema
